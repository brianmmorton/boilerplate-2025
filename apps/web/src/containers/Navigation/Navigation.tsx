  ...
  return (
    <div
      className={classNames(
        "block pr-6 pl-6 backdrop-blur-2xl sticky top-0 z-50 border-0"
      )}
    >
      <div className="py-4 px-8 lg:px-6 lg:py-2 border-b border-gray-300 mx-auto flex items-center justify-between text-blue-gray-700">
        {/* <Typography variant="h3">B</Typography> */}
        <SunIcon width={30} height={30} />
        <div className="flex items-center justify-between">
          <div className="hidden lg:block mr-8">{navList}</div>
            ...
            <Menu>
              <MenuList>
                <MenuItem
                  ...
                  key="Development"
                >
                  <Typography variant="small">Development</Typography>
                </MenuItem>
                <MenuItem
                  title="Staging"
                  key="Staging"
                >
                  <Typography variant="small">Staging</Typography>
                </MenuItem>
                <MenuItem
                  title="Production"
                  key="Production"
